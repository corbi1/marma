...
document.addEventListener('DOMContentLoaded', () => {
	...
	if (lessonNr == 1){
		document.getElementById("menueButton").setAttribute("onclick", "location.href='../../index.html';");
		document.querySelector("#menueButton img").setAttribute("src", "../../resources/icons/white/menue-icon.webp");
	}
    ...
    initDB().then(async (db) => {
        ...
        getRequest.onsuccess = async (event) => {
            ...
            if (!lessonData) {
                console.error('Lesson not found in DB: ' + lessonId);
                return;
            }
